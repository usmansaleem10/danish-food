...
function
getGmapsLang(){$map=array('bg_BG'=>'bg','cs_CZ'=>'cs','de_DE'=>'de','el'=>'el','en_US'=>'en','en_CA'=>'en-ca','en_GB'=>'en-gb','es_ES'=>'es','es_CL'=>'es-cl','es_AR'=>'es-ar','es_CL'=>'es-cl','es_CO'=>'es-co','es_GT'=>'es-gt','es_MX'=>'es-mx','es_PE'=>'es-pe','es_PR'=>'es-pr','es_VE'=>'es-ve','fi'=>'fi','fr_FR'=>'fr','hi_IN'=>'hi','hr'=>'hr','hu_HU'=>'hu','id_ID'=>'id','it_IT'=>'it','nl_NL'=>'nl','pl_PL'=>'pl','pt_BR'=>'pt-br','pt_PT'=>'pt-pt','ru_RU'=>'ru','sk_SK'=>'sk','sq'=>'sq','sv_SE'=>'sv','tr_TR'=>'tr','uk'=>'uk','zh_CN'=>'zh-cn','zh_TW'=>'zh-tw');$currentLocale=self::getCurrentLocale();if(isset($map[$currentLocale])){return$map[$currentLocale];}return'en';}static
function
...
AitSkeletonUpgrade2230;$this->errors=$upgrade->execute();}do_action('ait-skeleton-upgrade',$this);$this->addAdminErrorNotices();}function
